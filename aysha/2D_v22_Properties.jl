module Receiver2D_v22_Properties

export air_conductivity_v22, air_heat_capacity_v22, air_viscosity_v22, air_density_v22
export felt_conductivity_v22, felt_heat_capacity_v22
export sic_conductivity_v22, sic_heat_capacity_v22
export fully_developed_nusselt_v22
...
const GLOBAL_NU_MULTIPLIER = Ref(1.0)
const GLOBAL_ROSS_MULTIPLIER = Ref(1.0)

# 1. Corrected air conductivity (Sutherland, fixes 8% bias)
function air_conductivity_v22(T)
...
function sic_heat_capacity_v22(T)
    return _interp(T, _T_TAB, _SIC_CP_TAB)
end

# 6. Corrected Nusselt asymptote for constant wall temperature
function fully_developed_nusselt_v22()
    return 3.66 * GLOBAL_NU_MULTIPLIER[]
end
