# ============================================================================
# smoke_2D_v2.jl - Unit smoke test suite for 2D_v2.jl (SciML ODE Solver)
# ============================================================================

using Test

include(joinpath(@__DIR__, "..", "2D_v2.jl"))
using .Receiver2D_v2

@testset "2D_v2 SciML ODE Solver Smoke Test" begin
    ...
    # Material & physical property evaluations
    ...
    @test felt_conductivity_temp(1000.0) > felt_conductivity_temp(300.0)
    @test front_nusselt_correlation(1000.0, 295.0) > front_nusselt_correlation(300.0, 295.0)
