...
# ╔═╡ 9bb58afa-bb33-11ed-1457-ab115ce20119
begin
	import Pkg
	# Pkg.activate("/Users/aishamelhim/Documents/ResearchData/Julia files")
	using BSplineKit
	using CSV
	using DataFrames
	using Plots
...
# ╔═╡ 05357382-050f-4914-a6d7-8373774630d3
using PlutoUI

# ╔═╡ d568d207-c20c-4376-993c-77c06924b231
begin
#Exp 26
...
# ╔═╡ 79f96877-26ca-47be-b1cc-430648c4294a
begin
...
# ╔═╡ d1bb3783-f878-403b-8d7d-50b14125c98f
begin
#Exp 29
...
# ╔═╡ d1b64a7e-44a5-4adf-962f-1775b89f37cf
begin
#Exp 30
...
# ╔═╡ e5a9f43a-7f03-433d-b25b-21791530743e
begin
#Exp 32
...
# ╔═╡ 9bf8e951-b7b8-4641-9c08-1ff095a6bd2e
begin 
#Exp 68
...
# ╔═╡ 5c5c274c-f280-4b59-80f5-9993e6030855
begin 
#Exp 69
...
# ╔═╡ c3e3ef2c-bb07-469a-982c-3705699d2e98
begin 
#Exp 70
...
# ╔═╡ 5d644e68-d8e0-4003-8154-78f1992b36e4
begin 
#Exp 71
...
# ╔═╡ 514ff723-13cf-44e7-aa32-e7245cc060f0
begin 
#Exp 72
...
# ╔═╡ 6f0523f0-d80c-4f68-ada1-a72001ebd303
begin 
#Exp 73
...
# ╔═╡ 16144f19-aa4e-4af5-a561-35dae7d5d78f
begin 
#Exp 74
...
# ╔═╡ dd8b1eb0-db58-4e46-8a32-1f6cd425d86f
begin 
#Exp 75
...
# ╔═╡ b0dc8c50-ebe5-4b35-a148-45de713a7f2d
begin
	plot(xz_data,
...
plot!(xd1_data,
			y1d1_data, label= "7.12 lpm", title= "Gas Temperature Profile (TI-3) at 456 kW/m^2",  ylabel= "Temperature (°C)", xlabel=" Time (s)") 

end

# ╔═╡ 3162cd62-dbe2-4a50-9d3e-cf6def8818f6
begin
	plot(xz_data,
...
plot!(xd1_data,
			y2d1_data, label= "7.12 lpm", title= "Solid Temperature Profile (TI-8) at 456 kW/m^2",  ylabel= "Temperature (°C)", xlabel=" Time (s)") 
...
plot!(xi1_data,
			y1i1_data, label= "4.53 lpm", title= "Gas Steady State Temp. at 304 kW/m2",  ylabel= "Temperature (°C)", xlabel=" Time (s)") 
...
plot!(xi1_data,
			y2i1_data, label= "4.53 lpm", title= "Solid Steady State Temp. (T8) at 304 kW/m2",  ylabel= "Temperature (°C)", xlabel=" Time (s)") 
...
plot!(xn1_data,
			y1n1_data, label= "4.53 lpm", title= "Gas Steady State Temp. at 256 kW/m2",  ylabel= "Temperature (°C)", xlabel=" Time (s)") 
...
plot!(xn1_data,
			y2n1_data, label= "4.53 lpm", title= "Solid Steady State Temp. at 256 kW/m2",  ylabel= "Temperature (°C)", xlabel=" Time (s)") 
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "057ffe65bdc250d307a98ddf3fed97d9d0e683b1"
